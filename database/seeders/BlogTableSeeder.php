...
class BlogTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Blog::create([
            ...
            'imagen'=> 'Equipo',
            'descripción_corta'=> 'Aprende a copiar, mover y renombrar archivos usando la terminal de comandos de Linux.',
        ...
        Blog::create([
            ...
            'imagen'=> 'Equipo',
            'descripción_corta'=> 'La historia de la IA se remonta a los años 50 y ha evolucionado hasta lo que conocemos hoy en día. Te la cuento en este blog, porque en español, #NadieExplicaMejor que EDteam.',
        ...
        Blog::create([
            ...
            'imagen'=> 'Equipo',
            'descripción_corta'=> 'Adobe tiene años dominando el mercado del software de diseño, ¿esto cambiará con la compra de Affinity por Canva? De esto hablaremos en este blog, porque en español, #EDteamExplicaMejor.',
